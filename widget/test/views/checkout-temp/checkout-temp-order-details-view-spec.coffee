...
describe 'CheckoutTempOrderDetailsViewSpec', ->
  ...
  it 'should render', ->
    ...
    expect( @view.$ '.columnUnavailable').to.exist
  ...
  it  'should render item quantity', ->
    ...
    expect($itemQuantity.val()).to.be.equal('5')
  ...
  it  'should render just one selected quantity option', ->
    ...
    expect($selectedAttr).to.has.text('5')
