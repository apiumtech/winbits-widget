    ...
    <div class="checkoutMain">
      ...
      <div class="checkoutPayPal">
        <div class="checkoutPayPal-logo">
          ...
          <span class="icon validacion">Validación</span>
        </div>
        <div class="checkoutPayPal-container">
          <h4>Tu compra está en espera de validación.</h4>

          <p>Dentro de las próximas 2 horas se te enviará un correo notificandote el estatus de tu compra</p>

          <p>Puedes revisar el estado de tu validación en el <a href="#">historial de tu cuenta</a></p>
        </div>
