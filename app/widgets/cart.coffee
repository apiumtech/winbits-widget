module.exports = (app) ->
  ...
  app.addToUserCart = (id, quantity, bits) ->
  ...
  app.updateCartDetail = (cartDetail, quantity, bits) ->
  ...
  app.addToVirtualCart = (id, quantity) ->
  ...
  app.transferVirtualCart = ($, virtualCart) ->
